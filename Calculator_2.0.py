...
print("4.Division")
print("5.Power")
user_input = (input("Enter a choice: 1,2,3,4,5 or +,-,*,/,^ or skip: "))
if user_input == "":
    pass
elif user_input == "1":
    pass
...
print("4.Division")
print("5.Power")
user_input_2 = (input("Enter a choice: 1,2,3,4,5 or +,-,*,/,^ or skip: "))
if user_input_2 == "":
    pass
elif user_input_2 == "1":
    pass
...
if user_input == "" and user_input_2 == "":
    raise Exception("You need an operation for proper use.")
